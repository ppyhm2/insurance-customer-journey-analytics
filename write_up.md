# Insurance Customer Journey Analytics — Project Write-Up
...
**Columns:** `decline_id`, `quote_id`, `proposal_id`, `insurer_name`, `quote_status`, `brand`, `car_make`, `car_model`, `user_age`, `user_age_category`, `postcode`, `reason_code`, `data_refreshed_on`
...
- `monthly_premium` is always positive
